...
class TareasControllerTest < ActionController::TestCase
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post :create, tarea: { enunciado: @tarea.enunciado, fecha: @tarea.fecha, hour: @tarea.hour, tematica: @tarea.tematica }
    end
  ...
  test "should update tarea" do
    patch :update, id: @tarea, tarea: { enunciado: @tarea.enunciado, fecha: @tarea.fecha, hour: @tarea.hour, tematica: @tarea.tematica }
    assert_redirected_to tarea_path(assigns(:tarea))
  end
