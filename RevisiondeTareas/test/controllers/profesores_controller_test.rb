...
class ProfesoresControllerTest < ActionController::TestCase
  ...
  test "should create profesore" do
    assert_difference('Profesore.count') do
      post :create, profesore: { asignatura: @profesore.asignatura, email: @profesore.email, lastname: @profesore.lastname, name: @profesore.name }
    end
  ...
  test "should update profesore" do
    patch :update, id: @profesore, profesore: { asignatura: @profesore.asignatura, email: @profesore.email, lastname: @profesore.lastname, name: @profesore.name }
    assert_redirected_to profesore_path(assigns(:profesore))
  end
