...
class AsignaturasControllerTest < ActionController::TestCase
  ...
  test "should create asignatura" do
    assert_difference('Asignatura.count') do
      post :create, asignatura: { area: @asignatura.area, code: @asignatura.code, day: @asignatura.day, hour: @asignatura.hour, name: @asignatura.name }
    end
  ...
  test "should update asignatura" do
    patch :update, id: @asignatura, asignatura: { area: @asignatura.area, code: @asignatura.code, day: @asignatura.day, hour: @asignatura.hour, name: @asignatura.name }
    assert_redirected_to asignatura_path(assigns(:asignatura))
  end
